...
<title><?php bloginfo('name'); ?> &rsaquo; <?php bp_is_register_page() ? esc_html_e( 'Register', 'bp-restrict-community' ) : esc_html_e( 'Activate', 'bp-restrict-community' ); ?></title>
...
if ( is_multisite() ) {
	...
	$register_header_url   = __( 'https://wordpress.org/' );
	$register_header_title = __( 'Powered by WordPress' );
}
 ...
 */
bp_restricted_community()->register_header_url = apply_filters( 'login_headerurl', $register_header_url );
 ...
 */
bp_restricted_community()->register_header_title = apply_filters( 'login_headertitle', $register_header_title );
?>
</head>
